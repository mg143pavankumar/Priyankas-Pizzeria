...
<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<ul class="navbar-nav mx-auto text-center">
						...
						<li class="nav-item">
							<a class="nav-link scroll text-white" href="#contact">Contact Us</a>
						</li>
					</ul>
				...
				<div class="slider-info bg1">
					<div class="w3l-overlay">
						<div class="banner-text text-center container">
							<h3 class="text-white mb-md-4 mb-3">Order from 
								<span>Priyanka's Pizzeria</span>
							</h3>
							<p class="movetxt text-white mb-4">Login to order from the nearest Priyanka's Pizzeria outlet.</p>
	...
	<div class="about py-5" id="about">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-center text-dark mb-sm-5 mb-4">
				<span>Order from Priyanka's Pizzeria</span> Your one stop destination for the best ever Pizzas. </h3>
			...
			<div class="row pt-lg-5">
				...
				<div class="col-lg-4 mt-lg-0 mt-4">
					<div class="service1-wthree">
						<h4>1</h4>
						<h6 class="text-dark mt-3 mb-2">Quality</h6>
						<p>We assure you we follow strict guidelines to ensure we deliver you top quality pizzas.</p>
					</div>
					<div class="service1-wthree my-4">
						<h4>2</h4>
						<h6 class="text-dark mt-4 mb-2">Tasty</h6>
						<p>While providing you with best standards of quality, we deliver you the yummiest pizzas</p>
					</div>
					<div class="service1-wthree">
						<h4>3</h4>
						<h6 class="text-dark mt-4 mb-2">Pricability</h6>
						<p>Top notch pizzas doesn't mean over the top prices. We're surprising you with prices lower than our competitors</p>
					</div>
				</div>
	...
	<!-- contact -->
	<div class="address py-5 bg-dark text-white" id="contact" >
		<div class="container py-xl-5 py-lg-3 " >
			<h3 class="title text-center text-white mb-sm-5 mb-4">
				<span>Contact US</span> Priyanka's Pizzeria</h3>
			<div class="row address-row pt-lg-5">
				<div class="col-lg-6">
					<div class="address-right p-sm-5 p-4">
						<div class="address-info wow fadeInRight animated" data-wow-delay=".5s">
							<h4 class="mb-3">Address</h4>
							<p>123 221B Baker Street,
						...
						<div class="address-info agileits-info wow fadeInRight animated" data-wow-delay=".6s">
							...
							<p>
								<a href="priya81064@gmail.com"> Priyankaspizzeria@gmail.com</a>
							</p>
							<p>
								<a href="priya81064@gmail.com"> order@priyaspizzeria.com</a>
							</p>
						</div>
					</div>
				</div>
	...
	<footer class="pt-5">
		...
		<div class="copy_right">
			<p class="text-center text-white py-sm-4 py-3">© 2020 Priya's Pizzeria. All rights reserved
			</p>
